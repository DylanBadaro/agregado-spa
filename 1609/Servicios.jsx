...
import Calendar from 'react-calendar'; // Asegúrate de instalar react-calendar: npm install react-calendar
    ...
    <section id="servicios" className="py-16 bg-white">
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg text-gray-700 mb-8">
          Ofrecemos una variedad de servicios de spa, desde masajes relajantes hasta tratamientos de belleza.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-left">
              ...
              <li>Crio frecuencia facial: produce el “SHOCK TERMICO” logrando resultados instantáneos de efecto lifting</li>
            </ul>
          </div>

          {/* Tratamientos Corporales */}
          <div>
            <h3 className="text-xl font-semibold mb-2">Tratamientos Corporales</h3>
            <ul className="list-disc list-inside text-left">
              <li>VelaSlim: Reducción de la circunferencia corporal y la celulitis</li>
              <li>DermoHealth: moviliza los distintos tejidos de la piel y estimula la microcirculación, generando un drenaje linfático</li>
        ...
        <form onSubmit={handleSubmit} className="bg-gray-100 p-6 rounded-lg shadow-lg">
          <div className="mb-4">
            <label htmlFor="service" className="block text-lg font-medium text-gray-700 mb-2">Selecciona el Servicio:</label>
            <select id="service" value={service} onChange={handleServiceChange} className="form-select w-full p-2 border border-gray-300 rounded-lg">
          ...
          <div className="mb-4">
            <label htmlFor="calendar" className="block text-lg font-medium text-gray-700 mb-2">Selecciona la Fecha:</label>
            <Calendar
              id="calendar"
          ...
          <div className="mb-4">
            <label htmlFor="time" className="block text-lg font-medium text-gray-700 mb-2">Selecciona la Hora:</label>
            <input
              type="time"
              id="time"
              value={time}
          ...
          <button type="submit" className="bg-blue-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-600 transition duration-300">
            Reservar
          </button>
        </form>
      </div>
